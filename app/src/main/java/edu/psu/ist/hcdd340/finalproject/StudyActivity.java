...
public class StudyActivity extends AppCompatActivity implements NavigationBarView.OnItemSelectedListener{

    private BottomNavigationView bottomNavigationView;
    private static final String TAG = "ACTIVITY_STUDY";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bottomNavigationView.setSelectedItemId(R.id.navbar_study_item);
        ...
        if (bottomNavigationView.getSelectedItemId() != itemId) {
            switch (itemId) {
                ...
                case R.id.navbar_schedule_item:
                    ...
                    scheduleIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
